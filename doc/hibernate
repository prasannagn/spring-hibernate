...
many-to-one: <many-to-one name="address" column="address"  class="Address" not-null="true"/>
one-to-one: <many-to-one name="address" column="address" unique="true" class="Address" not-null="true"/>
one-to-many:
